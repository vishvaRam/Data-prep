...
if __name__ == "__main__":
    generator = QAGenerator(
        ...
        temperature=0.6,
        requests_per_minute=2000, # Keep this reasonable to avoid hitting per-minute limits too often
        max_iterations=20, # Max Q&A pairs per chunk
        max_consecutive_duplicates=3
    )

    chunks_path = "/workspaces/Data_prep/Data/Chunks/2022"
    metadata_path = "/workspaces/Data_prep/Data/meta-data/metadata_2022.json"
    output_file = "/workspaces/Data_prep/Data/QA/generated_qa_pairs_2022.json"
